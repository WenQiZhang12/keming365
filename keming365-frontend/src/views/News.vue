...
const openDetail = (id: string | number) => {
  const url = router.resolve({ name: 'NewsDetail', params: { id } }).href
...
.breadcrumb { font-size: 13px; color: #999; margin-bottom: 16px;
  a { color: #1769e8; &:hover { text-decoration: underline; } }
}
.page-header { text-align: center; padding: 40px 20px 30px;
  h1 { font-size: 28px; color: #1769e8; margin-bottom: 8px; }
...
.search-bar {
  ...
  input { flex: 1; padding: 10px 16px; border: 1px solid #ddd; border-radius: 8px 0 0 8px; font-size: 14px; outline: none;
    &:focus { border-color: #1769e8; box-shadow: 0 0 0 3px rgba(23, 105, 232, .1); }
  }
  button { padding: 10px 20px; background: #1769e8; color: #fff; border: none; border-radius: 0 8px 8px 0; font-size: 14px;
    &:hover { background: #0d5bd6; }
  }
}
