...
YQ_CLOUD_CONFIGS = {
    'experiment': {
        'appKey': os.environ.get('YQ_APPKEY_EXPERIMENT', ''),
        'appSecret': os.environ.get('YQ_APPSECRET_EXPERIMENT', ''),
    },
    'fragment': {
        'appKey': os.environ.get('YQ_APPKEY_FRAGMENT', ''),
        'appSecret': os.environ.get('YQ_APPSECRET_FRAGMENT', ''),
    },
    'training': {
        'appKey': os.environ.get('YQ_APPKEY_TRAINING', ''),
        'appSecret': os.environ.get('YQ_APPSECRET_TRAINING', ''),
    },
}
